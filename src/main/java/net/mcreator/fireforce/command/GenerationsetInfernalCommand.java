...
import net.mcreator.fireforce.procedures.GetInfernalProcedure;
	...
	public static void registerCommands(RegisterCommandsEvent event) {
		event.getDispatcher().register(LiteralArgumentBuilder.<CommandSource>literal("generation_set_infernal").requires(s -> s.hasPermissionLevel(4))
				.executes(arguments -> {
					...
					GetInfernalProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
