...
import net.mcreator.fireforce.procedures.ShownovaProcedure;
...
public class VoltageNovaGUIOverlay {
	@OnlyIn(Dist.CLIENT)
	...
	public static void eventHandler(RenderGameOverlayEvent.Post event) {
		if (event.getType() == RenderGameOverlayEvent.ElementType.HELMET) {
			...
			if (ShownovaProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
				...
				Minecraft.getInstance().getTextureManager().bindTexture(new ResourceLocation("fireforce:textures/screens/vn2.png"));
				Minecraft.getInstance().ingameGUI.blit(event.getMatrixStack(), posX + 171, posY + 57, 0, 0, 22, 22, 22, 22);

				Minecraft.getInstance().getTextureManager().bindTexture(new ResourceLocation("fireforce:textures/screens/vn.png"));
				Minecraft.getInstance().ingameGUI.blit(event.getMatrixStack(), posX + 148, posY + 57, 0, 0, 22, 22, 22, 22);

				Minecraft.getInstance().getTextureManager().bindTexture(new ResourceLocation("fireforce:textures/screens/vn3.png"));
				Minecraft.getInstance().ingameGUI.blit(event.getMatrixStack(), posX + 194, posY + 57, 0, 0, 22, 22, 22, 22);
