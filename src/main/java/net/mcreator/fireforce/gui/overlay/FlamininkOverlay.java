...
import net.mcreator.fireforce.procedures.ShowinkProcedure;
...
public class FlamininkOverlay {
	...
	public static void eventHandler(RenderGameOverlayEvent.Post event) {
		if (event.getType() == RenderGameOverlayEvent.ElementType.HELMET) {
			...
			if (ShowinkProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
				...
				Minecraft.getInstance().getTextureManager().bindTexture(new ResourceLocation("fireforce:textures/screens/fi.png"));
				Minecraft.getInstance().ingameGUI.blit(event.getMatrixStack(), posX + 171, posY + 57, 0, 0, 22, 22, 22, 22);

				Minecraft.getInstance().getTextureManager().bindTexture(new ResourceLocation("fireforce:textures/screens/fi1.png"));
				Minecraft.getInstance().ingameGUI.blit(event.getMatrixStack(), posX + 148, posY + 57, 0, 0, 22, 22, 22, 22);

				Minecraft.getInstance().getTextureManager().bindTexture(new ResourceLocation("fireforce:textures/screens/fi2.png"));
				Minecraft.getInstance().ingameGUI.blit(event.getMatrixStack(), posX + 194, posY + 57, 0, 0, 22, 22, 22, 22);
				...
				Minecraft.getInstance().getTextureManager().bindTexture(new ResourceLocation("fireforce:textures/screens/fi3.png"));
				Minecraft.getInstance().ingameGUI.blit(event.getMatrixStack(), posX + 171, posY + 80, 0, 0, 22, 22, 22, 22);
