...
import net.mcreator.fireforce.procedures.ShowabsProcedure;
...
public class AbsorbOverlay {
	...
	public static void eventHandler(RenderGameOverlayEvent.Post event) {
		if (event.getType() == RenderGameOverlayEvent.ElementType.HELMET) {
			...
			if (ShowabsProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
				...
				Minecraft.getInstance().getTextureManager().bindTexture(new ResourceLocation("fireforce:textures/screens/ability1.png"));
				Minecraft.getInstance().ingameGUI.blit(event.getMatrixStack(), posX + 171, posY + 80, 0, 0, 22, 22, 22, 22);

				Minecraft.getInstance().getTextureManager().bindTexture(new ResourceLocation("fireforce:textures/screens/line2.png"));
				Minecraft.getInstance().ingameGUI.blit(event.getMatrixStack(), posX + 178, posY + 74, 0, 0, 8, 8, 8, 8);

				Minecraft.getInstance().getTextureManager().bindTexture(new ResourceLocation("fireforce:textures/screens/absorb.png"));
				Minecraft.getInstance().ingameGUI.blit(event.getMatrixStack(), posX + 171, posY + 57, 0, 0, 22, 22, 22, 22);

				Minecraft.getInstance().getTextureManager().bindTexture(new ResourceLocation("fireforce:textures/screens/absorb1.png"));
				Minecraft.getInstance().ingameGUI.blit(event.getMatrixStack(), posX + 148, posY + 57, 0, 0, 22, 22, 22, 22);

				Minecraft.getInstance().getTextureManager().bindTexture(new ResourceLocation("fireforce:textures/screens/absorb2.png"));
				Minecraft.getInstance().ingameGUI.blit(event.getMatrixStack(), posX + 194, posY + 57, 0, 0, 22, 22, 22, 22);

				Minecraft.getInstance().getTextureManager().bindTexture(new ResourceLocation("fireforce:textures/screens/absorb3.png"));
				Minecraft.getInstance().ingameGUI.blit(event.getMatrixStack(), posX + 171, posY + 80, 0, 0, 22, 22, 22, 22);
				...
				if (Lock3Procedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
						(_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll))) {
					Minecraft.getInstance().getTextureManager().bindTexture(new ResourceLocation("fireforce:textures/screens/locked.png"));
					Minecraft.getInstance().ingameGUI.blit(event.getMatrixStack(), posX + 175, posY + 84, 0, 0, 14, 14, 14, 14);
				}
				...
				Minecraft.getInstance().fontRenderer.drawString(event.getMatrixStack(),
						"Heat Absorbed: " + (int) ((entity.getCapability(FireforceModVariables.PLAYER_VARIABLES_CAPABILITY, null)
								.orElse(new FireforceModVariables.PlayerVariables())).heatabsorbed) + "",
						posX + 181, posY + -149, -65536);
			}
