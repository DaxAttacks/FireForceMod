...
import net.mcreator.fireforce.procedures.KeyXProcedure;
...
public class IgnitionAbility2KeyBinding extends FireforceModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;

	public IgnitionAbility2KeyBinding(FireforceModElements instance) {
		super(instance, 7);
	...
	private static void pressAction(PlayerEntity entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			KeyXProcedure.executeProcedure(Stream
