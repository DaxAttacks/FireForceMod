...
package net.mcreator.fireforce.keybind;
...
import net.mcreator.fireforce.procedures.KeyCProcedure;
...
public class IgnitionAbility3KeyBinding extends FireforceModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;

	public IgnitionAbility3KeyBinding(FireforceModElements instance) {
		super(instance, 8);
	...
	public void initElements() {
		keys = new KeyBinding("key.fireforce.ignition_ability_3", GLFW.GLFW_KEY_C, "key.categories.fireforce");
	...
	private static void pressAction(PlayerEntity entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			KeyCProcedure.executeProcedure(Stream
