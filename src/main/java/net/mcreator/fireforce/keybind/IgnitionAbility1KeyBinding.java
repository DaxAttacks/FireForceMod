...
public class IgnitionAbility1KeyBinding extends FireforceModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;

	public IgnitionAbility1KeyBinding(FireforceModElements instance) {
		super(instance, 6);
	...
	public void initElements() {
		keys = new KeyBinding("key.fireforce.ignition_ability_1", GLFW.GLFW_KEY_Z, "key.categories.fireforce");
