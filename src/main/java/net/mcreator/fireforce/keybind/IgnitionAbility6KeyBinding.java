...
public class IgnitionAbility6KeyBinding extends FireforceModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;

	public IgnitionAbility6KeyBinding(FireforceModElements instance) {
		super(instance, 308);
	...
	public void initElements() {
		keys = new KeyBinding("key.fireforce.ignition_ability_6", GLFW.GLFW_KEY_N, "key.categories.misc");
