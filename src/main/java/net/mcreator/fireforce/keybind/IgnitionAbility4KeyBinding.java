...
public class IgnitionAbility4KeyBinding extends FireforceModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;

	public IgnitionAbility4KeyBinding(FireforceModElements instance) {
		super(instance, 9);
	...
	public void initElements() {
		keys = new KeyBinding("key.fireforce.ignition_ability_4", GLFW.GLFW_KEY_V, "key.categories.fireforce");
