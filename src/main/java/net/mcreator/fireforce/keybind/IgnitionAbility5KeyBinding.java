...
public class IgnitionAbility5KeyBinding extends FireforceModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;

	public IgnitionAbility5KeyBinding(FireforceModElements instance) {
		super(instance, 307);
	...
	public void initElements() {
		keys = new KeyBinding("key.fireforce.ignition_ability_5", GLFW.GLFW_KEY_B, "key.categories.misc");
