...
public class CharcaterProfileKeyBinding extends FireforceModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;

	public CharcaterProfileKeyBinding(FireforceModElements instance) {
		super(instance, 26);
	...
	public void initElements() {
		keys = new KeyBinding("key.fireforce.charcater_profile", GLFW.GLFW_KEY_P, "key.categories.fireforce");
