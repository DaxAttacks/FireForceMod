...
import net.mcreator.fireforce.procedures.StaminaProcedure;
...
public class ChargeKeyKeyBinding extends FireforceModElements.ModElement {
	...
	public void initElements() {
		keys = new KeyBinding("key.fireforce.charge_key", GLFW.GLFW_KEY_LEFT_CONTROL, "key.categories.fireforce");
