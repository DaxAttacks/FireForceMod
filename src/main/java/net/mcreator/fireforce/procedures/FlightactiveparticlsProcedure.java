...
public class FlightactiveparticlsProcedure {
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				FireforceMod.LOGGER.warn("Failed to load dependency entity for procedure Flightactiveparticls!");
			return;
		}
				...
				.orElse(new FireforceModVariables.PlayerVariables())).devilsflightlevel == 1) {
			{
				...
				if (!_ent.world.isRemote && _ent.world.getServer() != null) {
					_ent.world.getServer().getCommandManager().handleCommand(_ent.getCommandSource().withFeedbackDisabled().withPermissionLevel(4),
							"particle flame ^ ^-0.5 ^ 0.2 0.4 0.2 999 100 force");
				}
			}
