				...
				if ((entity.getCapability(FireforceModVariables.PLAYER_VARIABLES_CAPABILITY, null)
					...
					if ((entity.getCapability(FireforceModVariables.PLAYER_VARIABLES_CAPABILITY, null)
							.orElse(new FireforceModVariables.PlayerVariables())).FireOxygen >= (entity
									...
									.orElse(new FireforceModVariables.PlayerVariables())).FireOxygen * 0.03) {
						{
							...
							private void run() {
								{
									...
									if (!projectileLevel.isRemote()) {
										...
										}.getArrow(projectileLevel, entity, 0, 3, (byte) 3);
							...
							private void run() {
								{
									...
									if (!projectileLevel.isRemote()) {
										...
										_entityToSpawn.setPosition(_shootFrom.getPosX(), _shootFrom.getPosYEye() - 0.1, _shootFrom.getPosZ());
										_entityToSpawn.shoot(_shootFrom.getLookVec().x, _shootFrom.getLookVec().y, _shootFrom.getLookVec().z, 35, 0);
										projectileLevel.addEntity(_entityToSpawn);
									}
								}
								{
