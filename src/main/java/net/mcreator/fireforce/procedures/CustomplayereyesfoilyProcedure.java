...
public class CustomplayereyesfoilyProcedure {
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				FireforceMod.LOGGER.warn("Failed to load dependency entity for procedure Customplayereyesfoily!");
			return;
		}
		...
		if ((entity.getCapability(FireforceModVariables.PLAYER_VARIABLES_CAPABILITY, null)
			...
			if ((entity.getDisplayName().getString()).equals("_Foily")) {
				if (_evt.getRenderer() instanceof PlayerRenderer) {
					...
					new com.kleiders.kleidersplayerrenderer.InternalPlayerRenderer(_evt.getRenderer().getRenderManager(),
							new ResourceLocation("fireforce:textures/entities/foilyeyes.png")).render((AbstractClientPlayerEntity) _evt.getEntity(),
