...
import net.mcreator.fireforce.item.NovaExpelL4EItem;
import net.mcreator.fireforce.item.NovaExpelL3EItem;
import net.mcreator.fireforce.item.NovaExpelL2EItem;
import net.mcreator.fireforce.item.NovaExpelL1EItem;
import net.mcreator.fireforce.FireforceModVariables;
import net.mcreator.fireforce.FireforceMod;

import java.util.Map;

public class Novaexpel1Procedure {

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				FireforceMod.LOGGER.warn("Failed to load dependency world for procedure Novaexpel1!");
			return;
		}
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				FireforceMod.LOGGER.warn("Failed to load dependency x for procedure Novaexpel1!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				FireforceMod.LOGGER.warn("Failed to load dependency y for procedure Novaexpel1!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				FireforceMod.LOGGER.warn("Failed to load dependency z for procedure Novaexpel1!");
			return;
		}
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				FireforceMod.LOGGER.warn("Failed to load dependency entity for procedure Novaexpel1!");
			return;
		}
										...
										if (!projectileLevel.isRemote()) {
											ProjectileEntity _entityToSpawn = new Object() {
												public ProjectileEntity getArrow(World world, Entity shooter, float damage, int knockback) {
													AbstractArrowEntity entityToSpawn = new NovaExpelL1EItem.ArrowCustomEntity(NovaExpelL1EItem.arrow,
															world);
								...
								private void run() {
												...
												.addPotionEffect(new EffectInstance(Effects.RESISTANCE, (int) 5, (int) 80, (false), (false)));
									{
										...
										if (!projectileLevel.isRemote()) {
											ProjectileEntity _entityToSpawn = new Object() {
												public ProjectileEntity getArrow(World world, Entity shooter, float damage, int knockback) {
													AbstractArrowEntity entityToSpawn = new NovaExpelL3EItem.ArrowCustomEntity(NovaExpelL3EItem.arrow,
															world);
													entityToSpawn.setShooter(shooter);
													entityToSpawn.setDamage(damage);
													entityToSpawn.setKnockbackStrength(knockback);
								...
								private void run() {
												...
												.addPotionEffect(new EffectInstance(Effects.RESISTANCE, (int) 5, (int) 80, (false), (false)));
									{
										...
										if (!projectileLevel.isRemote()) {
											ProjectileEntity _entityToSpawn = new Object() {
												public ProjectileEntity getArrow(World world, Entity shooter, float damage, int knockback) {
													AbstractArrowEntity entityToSpawn = new NovaExpelL4EItem.ArrowCustomEntity(NovaExpelL4EItem.arrow,
															world);
													entityToSpawn.setShooter(shooter);
													entityToSpawn.setDamage(damage);
													entityToSpawn.setKnockbackStrength(knockback);
								...
								private void run() {
												...
												.addPotionEffect(new EffectInstance(Effects.RESISTANCE, (int) 5, (int) 80, (false), (false)));
									{
										...
										if (!projectileLevel.isRemote()) {
											ProjectileEntity _entityToSpawn = new Object() {
												public ProjectileEntity getArrow(World world, Entity shooter, float damage, int knockback) {
													AbstractArrowEntity entityToSpawn = new NovaExpelL5EItem.ArrowCustomEntity(NovaExpelL5EItem.arrow,
															world);
													entityToSpawn.setShooter(shooter);
													entityToSpawn.setDamage(damage);
													entityToSpawn.setKnockbackStrength(knockback);
