...
public class Testeyes4Procedure {
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				FireforceMod.LOGGER.warn("Failed to load dependency entity for procedure Testeyes4!");
			return;
		}
		...
		if (Blocks.EMERALD_BLOCK.asItem() == ((entity instanceof LivingEntity) ? ((LivingEntity) entity).getHeldItemMainhand() : ItemStack.EMPTY)
				.getItem()) {
			if (_evt.getRenderer() instanceof PlayerRenderer) {
				...
				new com.kleiders.kleidersplayerrenderer.InternalPlayerRenderer(_evt.getRenderer().getRenderManager(),
						new ResourceLocation("fireforce:textures/entities/natakueyes2.png")).render((AbstractClientPlayerEntity) _evt.getEntity(),
