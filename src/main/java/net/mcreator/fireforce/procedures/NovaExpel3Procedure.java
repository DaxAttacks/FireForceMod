...
import net.mcreator.fireforce.item.NovalExpelL3E5Item;
import net.mcreator.fireforce.item.NovalExpelL3E4Item;
import net.mcreator.fireforce.item.NovalExpelL3E3Item;
import net.mcreator.fireforce.item.NovalExpelL3E1Item;
import net.mcreator.fireforce.item.NovaExpelL3E0Item;
...
public class NovaExpel3Procedure {

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				FireforceMod.LOGGER.warn("Failed to load dependency world for procedure NovaExpel3!");
			return;
		}
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				FireforceMod.LOGGER.warn("Failed to load dependency x for procedure NovaExpel3!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				FireforceMod.LOGGER.warn("Failed to load dependency y for procedure NovaExpel3!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				FireforceMod.LOGGER.warn("Failed to load dependency z for procedure NovaExpel3!");
			return;
		}
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				FireforceMod.LOGGER.warn("Failed to load dependency entity for procedure NovaExpel3!");
			return;
		}
										...
										if (!projectileLevel.isRemote()) {
											ProjectileEntity _entityToSpawn = new Object() {
												public ProjectileEntity getArrow(World world, Entity shooter, float damage, int knockback) {
													AbstractArrowEntity entityToSpawn = new NovaExpelL3E0Item.ArrowCustomEntity(
															NovaExpelL3E0Item.arrow, world);
								...
								private void run() {
												...
												.addPotionEffect(new EffectInstance(Effects.RESISTANCE, (int) 5, (int) 80, (false), (false)));
									{
										...
										if (!projectileLevel.isRemote()) {
											ProjectileEntity _entityToSpawn = new Object() {
												public ProjectileEntity getArrow(World world, Entity shooter, float damage, int knockback) {
													AbstractArrowEntity entityToSpawn = new NovalExpelL3E1Item.ArrowCustomEntity(
															NovalExpelL3E1Item.arrow, world);
													entityToSpawn.setShooter(shooter);
													entityToSpawn.setDamage(damage);
													entityToSpawn.setKnockbackStrength(knockback);
													entityToSpawn.setSilent(true);
								...
								private void run() {
									{
										...
										if (!projectileLevel.isRemote()) {
											ProjectileEntity _entityToSpawn = new Object() {
												public ProjectileEntity getArrow(World world, Entity shooter, float damage, int knockback) {
													AbstractArrowEntity entityToSpawn = new NovalExpelL3E3Item.ArrowCustomEntity(
															NovalExpelL3E3Item.arrow, world);
													entityToSpawn.setShooter(shooter);
													entityToSpawn.setDamage(damage);
													entityToSpawn.setKnockbackStrength(knockback);
													entityToSpawn.setSilent(true);
								...
								private void run() {
												...
												.addPotionEffect(new EffectInstance(Effects.RESISTANCE, (int) 5, (int) 80, (false), (false)));
									{
										...
										if (!projectileLevel.isRemote()) {
											ProjectileEntity _entityToSpawn = new Object() {
												public ProjectileEntity getArrow(World world, Entity shooter, float damage, int knockback) {
													AbstractArrowEntity entityToSpawn = new NovalExpelL3E4Item.ArrowCustomEntity(
															NovalExpelL3E4Item.arrow, world);
													entityToSpawn.setShooter(shooter);
													entityToSpawn.setDamage(damage);
													entityToSpawn.setKnockbackStrength(knockback);
													entityToSpawn.setSilent(true);
								...
								private void run() {
												...
												.addPotionEffect(new EffectInstance(Effects.RESISTANCE, (int) 5, (int) 80, (false), (false)));
									{
										...
										if (!projectileLevel.isRemote()) {
											ProjectileEntity _entityToSpawn = new Object() {
												public ProjectileEntity getArrow(World world, Entity shooter, float damage, int knockback) {
													AbstractArrowEntity entityToSpawn = new NovalExpelL3E5Item.ArrowCustomEntity(
															NovalExpelL3E5Item.arrow, world);
													entityToSpawn.setShooter(shooter);
													entityToSpawn.setDamage(damage);
													entityToSpawn.setKnockbackStrength(knockback);
													entityToSpawn.setSilent(true);
