...
public class ArroweyeProcedure {
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				FireforceMod.LOGGER.warn("Failed to load dependency entity for procedure Arroweye!");
			return;
		}
		...
		if ((entity.getCapability(FireforceModVariables.PLAYER_VARIABLES_CAPABILITY, null)
				.orElse(new FireforceModVariables.PlayerVariables())).Generation == 3) {
			if ((entity.getCapability(FireforceModVariables.PLAYER_VARIABLES_CAPABILITY, null)
				...
				if (_evt.getRenderer() instanceof PlayerRenderer) {
					...
					new com.kleiders.kleidersplayerrenderer.InternalPlayerRenderer(_evt.getRenderer().getRenderManager(),
							new ResourceLocation("fireforce:textures/entities/arroweyes.png")).render((AbstractClientPlayerEntity) _evt.getEntity(),
