...
public class Testeyes1Procedure {
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				FireforceMod.LOGGER.warn("Failed to load dependency entity for procedure Testeyes1!");
			return;
		}
		...
		if (Items.GOLD_INGOT == ((entity instanceof LivingEntity) ? ((LivingEntity) entity).getHeldItemMainhand() : ItemStack.EMPTY).getItem()) {
			if (_evt.getRenderer() instanceof PlayerRenderer) {
				...
				new com.kleiders.kleidersplayerrenderer.InternalPlayerRenderer(_evt.getRenderer().getRenderManager(),
						new ResourceLocation("fireforce:textures/entities/darknessdxdeyes.png")).render((AbstractClientPlayerEntity) _evt.getEntity(),
