...
import net.mcreator.fireforce.procedures.NEL3P3Procedure;
import net.mcreator.fireforce.entity.renderer.NovaExpelL2E3Renderer;
...
public class NovaExpelL2E3Item extends FireforceModElements.ModElement {
	@ObjectHolder("fireforce:nova_expel_l_2_e_3")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("projectile_nova_expel_l_2_e_3").setRegistryName("projectile_nova_expel_l_2_e_3");

	public NovaExpelL2E3Item(FireforceModElements instance) {
		super(instance, 219);
		FMLJavaModLoadingContext.get().getModEventBus().register(new NovaExpelL2E3Renderer.ModelRegisterHandler());
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			...
			setRegistryName("nova_expel_l_2_e_3");
		}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public void onCollideWithPlayer(PlayerEntity entity) {
			...
			NEL3P3Procedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
