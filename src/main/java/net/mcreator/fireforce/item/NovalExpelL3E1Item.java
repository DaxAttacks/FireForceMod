...
import net.mcreator.fireforce.procedures.NELL3P1Procedure;
import net.mcreator.fireforce.entity.renderer.NovalExpelL3E1Renderer;
...
public class NovalExpelL3E1Item extends FireforceModElements.ModElement {
	@ObjectHolder("fireforce:noval_expel_l_3_e_1")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("projectile_noval_expel_l_3_e_1").setRegistryName("projectile_noval_expel_l_3_e_1");

	public NovalExpelL3E1Item(FireforceModElements instance) {
		super(instance, 229);
		FMLJavaModLoadingContext.get().getModEventBus().register(new NovalExpelL3E1Renderer.ModelRegisterHandler());
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			...
			setRegistryName("noval_expel_l_3_e_1");
		}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public void onCollideWithPlayer(PlayerEntity entity) {
			...
			NELL3P1Procedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
