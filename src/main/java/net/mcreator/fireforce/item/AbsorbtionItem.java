...
public class AbsorbtionItem extends FireforceModElements.ModElement {
	@ObjectHolder("fireforce:absorbtion")
	public static final Item block = null;

	public AbsorbtionItem(FireforceModElements instance) {
		super(instance, 390);
	}
