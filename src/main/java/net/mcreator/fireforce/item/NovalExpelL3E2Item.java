...
import net.mcreator.fireforce.procedures.NELL3P2Procedure;
import net.mcreator.fireforce.entity.renderer.NovalExpelL3E2Renderer;
...
public class NovalExpelL3E2Item extends FireforceModElements.ModElement {
	@ObjectHolder("fireforce:noval_expel_l_3_e_2")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("projectile_noval_expel_l_3_e_2").setRegistryName("projectile_noval_expel_l_3_e_2");

	public NovalExpelL3E2Item(FireforceModElements instance) {
		super(instance, 230);
		FMLJavaModLoadingContext.get().getModEventBus().register(new NovalExpelL3E2Renderer.ModelRegisterHandler());
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			...
			setRegistryName("noval_expel_l_3_e_2");
		}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public void onCollideWithPlayer(PlayerEntity entity) {
			...
			NELL3P2Procedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
