...
import net.mcreator.fireforce.procedures.NEparticles4Procedure;
import net.mcreator.fireforce.procedures.NE4Procedure;
import net.mcreator.fireforce.entity.renderer.NE4EntityRenderer;
...
public class NE4EntityItem extends FireforceModElements.ModElement {
	@ObjectHolder("fireforce:ne_4_entity")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("projectile_ne_4_entity").setRegistryName("projectile_ne_4_entity");

	public NE4EntityItem(FireforceModElements instance) {
		super(instance, 184);
		FMLJavaModLoadingContext.get().getModEventBus().register(new NE4EntityRenderer.ModelRegisterHandler());
	}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public void onCollideWithPlayer(PlayerEntity entity) {
			...
			NE4Procedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
		...
		public void tick() {
			...
			NEparticles4Procedure.executeProcedure(Stream
