...
import net.mcreator.fireforce.procedures.NEL3P5Procedure;
import net.mcreator.fireforce.entity.renderer.NovaExpelL2E5Renderer;
...
public class NovaExpelL2E5Item extends FireforceModElements.ModElement {
	@ObjectHolder("fireforce:nova_expel_l_2_e_5")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("projectile_nova_expel_l_2_e_5").setRegistryName("projectile_nova_expel_l_2_e_5");

	public NovaExpelL2E5Item(FireforceModElements instance) {
		super(instance, 221);
		FMLJavaModLoadingContext.get().getModEventBus().register(new NovaExpelL2E5Renderer.ModelRegisterHandler());
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			...
			setRegistryName("nova_expel_l_2_e_5");
		}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public void onCollideWithPlayer(PlayerEntity entity) {
			...
			NEL3P5Procedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
