...
import net.mcreator.fireforce.procedures.NELL3P5Procedure;
import net.mcreator.fireforce.entity.renderer.NovalExpelL3E5Renderer;
...
public class NovalExpelL3E5Item extends FireforceModElements.ModElement {
	@ObjectHolder("fireforce:noval_expel_l_3_e_5")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("projectile_noval_expel_l_3_e_5").setRegistryName("projectile_noval_expel_l_3_e_5");

	public NovalExpelL3E5Item(FireforceModElements instance) {
		super(instance, 233);
		FMLJavaModLoadingContext.get().getModEventBus().register(new NovalExpelL3E5Renderer.ModelRegisterHandler());
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			...
			setRegistryName("noval_expel_l_3_e_5");
		}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public void onCollideWithPlayer(PlayerEntity entity) {
			...
			NELL3P5Procedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
