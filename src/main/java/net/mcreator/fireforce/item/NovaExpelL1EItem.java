...
import net.mcreator.fireforce.procedures.Novaexpellevel1projectileProcedure;
import net.mcreator.fireforce.entity.renderer.NovaExpelL1ERenderer;
...
public class NovaExpelL1EItem extends FireforceModElements.ModElement {
	@ObjectHolder("fireforce:nova_expel_l_1_e")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("projectile_nova_expel_l_1_e").setRegistryName("projectile_nova_expel_l_1_e");

	public NovaExpelL1EItem(FireforceModElements instance) {
		super(instance, 204);
		FMLJavaModLoadingContext.get().getModEventBus().register(new NovaExpelL1ERenderer.ModelRegisterHandler());
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			...
			setRegistryName("nova_expel_l_1_e");
		}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public void onCollideWithPlayer(PlayerEntity entity) {
			...
			Novaexpellevel1projectileProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
