...
import net.mcreator.fireforce.procedures.NE5Procedure;
import net.mcreator.fireforce.entity.renderer.NE5EntityRenderer;
...
public class NE5EntityItem extends FireforceModElements.ModElement {
	@ObjectHolder("fireforce:ne_5_entity")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("projectile_ne_5_entity").setRegistryName("projectile_ne_5_entity");

	public NE5EntityItem(FireforceModElements instance) {
		super(instance, 185);
		FMLJavaModLoadingContext.get().getModEventBus().register(new NE5EntityRenderer.ModelRegisterHandler());
	}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public void onCollideWithPlayer(PlayerEntity entity) {
			...
			NE5Procedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
