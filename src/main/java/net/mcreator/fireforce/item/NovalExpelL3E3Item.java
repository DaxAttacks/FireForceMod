...
public class NovalExpelL3E3Item extends FireforceModElements.ModElement {
	@ObjectHolder("fireforce:noval_expel_l_3_e_3")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("projectile_noval_expel_l_3_e_3").setRegistryName("projectile_noval_expel_l_3_e_3");

	public NovalExpelL3E3Item(FireforceModElements instance) {
		super(instance, 231);
		FMLJavaModLoadingContext.get().getModEventBus().register(new NovalExpelL3E3Renderer.ModelRegisterHandler());
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			...
			setRegistryName("noval_expel_l_3_e_3");
		}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public void onCollideWithPlayer(PlayerEntity entity) {
			...
			NELL3P3Procedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
