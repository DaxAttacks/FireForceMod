...
import net.mcreator.fireforce.procedures.NEL1P5Procedure;
import net.mcreator.fireforce.entity.renderer.NovaExpelL5ERenderer;
...
public class NovaExpelL5EItem extends FireforceModElements.ModElement {
	@ObjectHolder("fireforce:nova_expel_l_5_e")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("projectile_nova_expel_l_5_e").setRegistryName("projectile_nova_expel_l_5_e");

	public NovaExpelL5EItem(FireforceModElements instance) {
		super(instance, 208);
		FMLJavaModLoadingContext.get().getModEventBus().register(new NovaExpelL5ERenderer.ModelRegisterHandler());
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			...
			setRegistryName("nova_expel_l_5_e");
		}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public void onCollideWithPlayer(PlayerEntity entity) {
			...
			NEL1P5Procedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
