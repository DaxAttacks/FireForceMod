...
import net.mcreator.fireforce.procedures.NEL3P4Procedure;
import net.mcreator.fireforce.entity.renderer.NovaExpelL2E4Renderer;
...
public class NovaExpelL2E4Item extends FireforceModElements.ModElement {
	@ObjectHolder("fireforce:nova_expel_l_2_e_4")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("projectile_nova_expel_l_2_e_4").setRegistryName("projectile_nova_expel_l_2_e_4");

	public NovaExpelL2E4Item(FireforceModElements instance) {
		super(instance, 220);
		FMLJavaModLoadingContext.get().getModEventBus().register(new NovaExpelL2E4Renderer.ModelRegisterHandler());
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			...
			setRegistryName("nova_expel_l_2_e_4");
		}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public void onCollideWithPlayer(PlayerEntity entity) {
			...
			NEL3P4Procedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
