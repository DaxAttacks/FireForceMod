...
import net.mcreator.fireforce.procedures.NEpaticles2Procedure;
import net.mcreator.fireforce.procedures.NE2Procedure;
import net.mcreator.fireforce.entity.renderer.NovaExpelstage2Renderer;
...
public class NovaExpelstage2Item extends FireforceModElements.ModElement {
	@ObjectHolder("fireforce:nova_expelstage_2")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("projectile_nova_expelstage_2").setRegistryName("projectile_nova_expelstage_2");

	public NovaExpelstage2Item(FireforceModElements instance) {
		super(instance, 174);
		FMLJavaModLoadingContext.get().getModEventBus().register(new NovaExpelstage2Renderer.ModelRegisterHandler());
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			...
			setRegistryName("nova_expelstage_2");
		}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public void onCollideWithPlayer(PlayerEntity entity) {
			...
			NE2Procedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
		...
		public void tick() {
			...
			NEpaticles2Procedure.executeProcedure(Stream
