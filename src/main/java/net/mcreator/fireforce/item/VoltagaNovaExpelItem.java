...
import net.mcreator.fireforce.procedures.NovaExpellevel0projectileProcedure;
import net.mcreator.fireforce.entity.renderer.VoltagaNovaExpelRenderer;
...
public class VoltagaNovaExpelItem extends FireforceModElements.ModElement {
	@ObjectHolder("fireforce:voltaga_nova_expel")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("projectile_voltaga_nova_expel").setRegistryName("projectile_voltaga_nova_expel");

	public VoltagaNovaExpelItem(FireforceModElements instance) {
		super(instance, 169);
		FMLJavaModLoadingContext.get().getModEventBus().register(new VoltagaNovaExpelRenderer.ModelRegisterHandler());
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			...
			setRegistryName("voltaga_nova_expel");
		}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public void onCollideWithPlayer(PlayerEntity entity) {
			...
			NovaExpellevel0projectileProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
