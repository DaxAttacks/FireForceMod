...
import net.mcreator.fireforce.procedures.NE3particles3Procedure;
import net.mcreator.fireforce.procedures.NE3Procedure;
import net.mcreator.fireforce.entity.renderer.NE3EntityRenderer;
...
public class NE3EntityItem extends FireforceModElements.ModElement {
	@ObjectHolder("fireforce:ne_3_entity")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("projectile_ne_3_entity").setRegistryName("projectile_ne_3_entity");

	public NE3EntityItem(FireforceModElements instance) {
		super(instance, 179);
		FMLJavaModLoadingContext.get().getModEventBus().register(new NE3EntityRenderer.ModelRegisterHandler());
	}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public void onCollideWithPlayer(PlayerEntity entity) {
			...
			NE3Procedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
		...
		public void tick() {
			...
			NE3particles3Procedure.executeProcedure(Stream
