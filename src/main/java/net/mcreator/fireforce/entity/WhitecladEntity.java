...
import net.mcreator.fireforce.procedures.WhitecladEntityDiesProcedure;
import net.mcreator.fireforce.entity.renderer.WhitecladRenderer;
...
public class WhitecladEntity extends FireforceModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire()
			.size(0.6f, 1.8f)).build("whiteclad").setRegistryName("whiteclad");

	public WhitecladEntity(FireforceModElements instance) {
		super(instance, 384);
		FMLJavaModLoadingContext.get().getModEventBus().register(new WhitecladRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new SpawnEggItem(entity, -1, -65536, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("whiteclad_spawn_egg"));
	}

	@SubscribeEvent
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		event.getSpawns().getSpawner(EntityClassification.MONSTER).add(new MobSpawnInfo.Spawners(entity, 20, 1, 12));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public void onDeath(DamageSource source) {
			...
			WhitecladEntityDiesProcedure.executeProcedure(Stream
