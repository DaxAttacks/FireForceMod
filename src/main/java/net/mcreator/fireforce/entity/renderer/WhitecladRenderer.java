...
@OnlyIn(Dist.CLIENT)
public class WhitecladRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(WhitecladEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelwhiteclad(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("fireforce:textures/entities/whitecladarmy.png");
					}
				};
			});
		}
	...
	public static class Modelwhiteclad extends EntityModel<Entity> {
