...
import net.mcreator.fireforce.entity.renderer.HFRenderer;
import net.mcreator.fireforce.FireforceModElements;

@FireforceModElements.ModElement.Tag
public class HFEntity extends FireforceModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.6f, 1.8f)).build("hf").setRegistryName("hf");

	public HFEntity(FireforceModElements instance) {
		super(instance, 345);
		FMLJavaModLoadingContext.get().getModEventBus().register(new HFRenderer.ModelRegisterHandler());
